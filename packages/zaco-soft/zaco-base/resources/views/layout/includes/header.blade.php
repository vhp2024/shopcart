        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
                ...
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    ...
                    <li class="scrollable-container media-list">
                        <div class="list-item align-items-center">
                            <img class="d-block rounded me-1" src="/themes/admin/images/pages/eCommerce/1.png" alt="donuts" width="62">
                        ...
                        <div class="list-item align-items-center">
                            <img class="d-block rounded me-1" src="/themes/admin/images/pages/eCommerce/7.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1">
                                <i class="ficon cart-item-remove" data-feather="x"></i>
                                <div class="media-heading">
                                    <h6 class="cart-item-title">
                        ...
                        <div class="list-item align-items-center">
                            <img class="d-block rounded me-1" src="/themes/admin/images/pages/eCommerce/2.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1">
                                <i class="ficon cart-item-remove" data-feather="x"></i>
                                <div class="media-heading">
                                    <h6 class="cart-item-title">
                        ...
                        <div class="list-item align-items-center">
                            <img class="d-block rounded me-1" src="/themes/admin/images/pages/eCommerce/3.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1">
                                <i class="ficon cart-item-remove" data-feather="x"></i>
                                <div class="media-heading">
                                    <h6 class="cart-item-title">
                        ...
                        <div class="list-item align-items-center">
                            <img class="d-block rounded me-1" src="/themes/admin/images/pages/eCommerce/5.png" alt="donuts" width="62">
                            <div class="list-item-body flex-grow-1">
                                <i class="ficon cart-item-remove" data-feather="x"></i>
                                <div class="media-heading">
                                    <h6 class="cart-item-title">
                    ...
                    <li class="scrollable-container media-list">
                        <a class="d-flex" href="#">
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar">
                                        <img src="/themes/admin/images/portrait/small/avatar-s-15.jpg" alt="avatar" width="32" height="32">
                                    </div>
                                </div>
                                <div class="list-item-body flex-grow-1">
                        ...
                        <a class="d-flex" href="#">
                            <div class="list-item d-flex align-items-start">
                                <div class="me-1">
                                    <div class="avatar">
                                        <img src="/themes/admin/images/portrait/small/avatar-s-3.jpg" alt="avatar" width="32" height="32">
                                    </div>
                                </div>
                                <div class="list-item-body flex-grow-1">
                                    <p class="media-heading">
            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="avatar">
                        <img class="round" src="/themes/admin/images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    ...
                    @else
                        <a class="dropdown-item" href="{{ route('Auth::login') }}">
                            <i class="me-50" data-feather="power"></i> {{__('auth.sign_in')}}
                        </a>
                        <a class="dropdown-item" href="{{ route('Auth::register') }}">
                            <i class="me-50" data-feather="power"></i> {{ __('auth.register') }}
                        </a>
                    @endif
                </div>
            </li>
...
<ul class="main-search-list-defaultlist d-none">
    ...
    <!-- <li class="auto-suggestion">
        <a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75">
                    <img src="/themes/admin/images/icons/xls.png" alt="png" height="32">
                </div>
    ...
    <li class="auto-suggestion">
        <a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75">
                    <img src="/themes/admin/images/icons/jpg.png" alt="png" height="32">
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion">
        <a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75">
                    <img src="/themes/admin/images/icons/pdf.png" alt="png" height="32">
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion">
        <a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
            <div class="d-flex">
                <div class="me-75">
                    <img src="/themes/admin/images/icons/doc.png" alt="png" height="32">
                </div>
                <div class="search-data">
        ...
        <a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75">
                    <img src="/themes/admin/images/portrait/small/avatar-s-8.jpg" alt="png" height="32">
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion">
        <a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75">
                    <img src="/themes/admin/images/portrait/small/avatar-s-1.jpg" alt="png" height="32">
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion">
        <a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75">
                    <img src="/themes/admin/images/portrait/small/avatar-s-14.jpg" alt="png" height="32">
                </div>
                <div class="search-data">
    ...
    <li class="auto-suggestion">
        <a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view-account.html">
            <div class="d-flex align-items-center">
                <div class="avatar me-75">
                    <img src="/themes/admin/images/portrait/small/avatar-s-6.jpg" alt="png" height="32">
                </div>
                <div class="search-data">
